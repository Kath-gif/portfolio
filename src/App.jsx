...
function App() {
  ...
  <div className="home-content">
    <img className="profile-image" src="MyProfile.jpg" alt="profile" />
    <h1>Hello!</h1>
    <p>I am Cathrina Patisar.</p>
    <p>Welcome to my Portfolio!</p>
      ...
      <section id="projects" className="section projects-section">
        ...
        <div className="project-list">
          <div className="project-card1">
            ...
            <img src="project1.jpg" alt="ST" className="project-image" />
          ...
          <div className="project-card2">
            ...
            <img src="project2.jpg" alt="Awesome" className="project-image" />
      ...
      <p>Feel free to reach out!</p>
        <div className="contact-icons">
          <a href="mailto:patisarcathrina@gmail.com">
            <img src="gmail.png" alt="Email" />
          </a>
          <a href="https://www.facebook.com/katrina.patisar?mibextid=ZbWKwL" target="_blank" rel="noreferrer">
            <img src="fb.png" alt="Facebook" />
          </a>
          <a href="https://www.instagram.com/cathrinapatisar/profilecard/?igsh=MWJ1dGpuZG5uOG12bA==" target="_blank" rel="noreferrer">
            <img src="ig.png" alt="Instagram" />
          </a>
          <a href="https://github.com/Kath-gif" target="_blank" rel="noreferrer">
      ...
      {/* Footer */}
      <footer>
        <p>&copy; 2024 Cathrina Patisar. All rights reserved.</p>
      </footer>
    </div>
  );
}
